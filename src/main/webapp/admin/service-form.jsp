						...
						<form action="<%=request.getContextPath()%>/services"
							...
							%><div class="form-grid">
								<div class="form-group">
									<label class="form-label" for="name">Tên dịch vụ</label><input
										class="form-control" id="name" name="name" required
										placeholder="Ví dụ: Giặt ủi"
										value="<%=isEdit ? service.getName() : ""%>">
								</div>
								<div class="form-group">
									<label class="form-label" for="price">Giá dịch vụ (VNĐ)</label><input
										class="form-control" type="number" min="0" step="5000"
								...
								<div class="form-group full">
									...
									<textarea class="form-control" id="description"
										name="description"><%=isEdit && service.getDescription() != null ? service.getDescription() : ""%></textarea>
								</div>
							</div>
							<div class="form-actions">
								<a class="btn btn-outline"
									href="<%=request.getContextPath()%>/services?action=list">Hủy</a>
