          ...
          <div class="content-inner">
            <div class="page-head">
              <div>
                ...
                <p class="page-desc">Theo dõi lịch đặt và trạng thái nhận phòng.</p>
              </div>
              <div class="page-actions"><a class="btn btn-primary" href="booking-form.jsp">＋ Tạo mới</a></div>
            </div>
            <section class="surface">
              <div class="table-tools">
                <div class="search-box">
                  <input type="search" placeholder="Tìm theo mã đặt phòng, khách hàng hoặc số phòng..." />
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row-actions">
                          ...
                          <a class="btn btn-primary" href="payment.jsp">Trả phòng</a>
                        </div>
                      </td>
                    </tr>
                    <tr>
