...
<html lang="vi">
  <head>
    ...
    <title>Thêm khách hàng - Nestora</title>
      ...
      <main class="main-shell">
        ...
        <section class="content">
          <div class="content-inner">
            <div class="page-head">
              <div>
                <div class="breadcrumb">Vận hành / Khách hàng / Thêm mới</div>
                <h1 class="page-title">Thêm khách hàng</h1>
                <p class="page-desc">Lưu hồ sơ khách hàng để tạo đặt phòng.</p>
              </div>
            </div>
              ...
              <form>
                <div class="form-grid">
                  <div class="form-group">
                    ...
                    <div class="validation">Vui lòng nhập họ tên khách hàng</div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Nhập số giấy tờ" />
                  </div>
                  <div class="form-group">
                    <label class="form-label">Email</label>
                    <input class="form-control" type="email" placeholder="example@email.com" />
                    <div class="validation">Email chưa đúng định dạng</div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group full">
                    ...
                    <textarea class="form-control" placeholder="Thông tin cần lưu ý về khách hàng"></textarea>
                  </div>
                </div>
                <div class="form-actions">
                  <a class="btn btn-outline" href="customers.jsp">Hủy</a>
