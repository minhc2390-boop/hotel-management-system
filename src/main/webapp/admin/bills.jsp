          ...
          <div class="content-inner">
            <div class="page-head">
              ...
              <div class="page-actions">
                <a class="btn btn-outline" href="<%= request.getContextPath() %>/admin/payment.jsp">Trả phòng & thanh toán</a>
              </div>
            </div>
            <section class="surface">
              ...
              <div class="empty">
                ...
                Dữ liệu sẽ hiển thị khi có đặt phòng.
              </div>
              <% } %>
            </section>
          </div>
