  ...
  <body>
    <header class="public-header">
      ...
      <nav class="public-nav">
        ...
        <a class="active" href="<%= request.getContextPath() %>/bills?action=mybills">Phòng đã đặt</a>
    ...
    <main class="public-content">
      <div class="page-head">
        <div>
          ...
          <p class="page-desc">Theo dõi lịch sử lưu trú và thanh toán.</p>
        </div>
      </div>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-outline" href="<%= request.getContextPath() %>/bills?action=detail&id=<%= b.getId() %>">
                    Chi tiết
                  </a>
                </td>
              </tr>
