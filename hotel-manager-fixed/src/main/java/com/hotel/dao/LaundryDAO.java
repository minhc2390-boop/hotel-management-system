    ...
    public List<Laundry> searchLaundries(String keyword, String status) {
        ...
        try {
            ...
            if (status != null && !status.trim().isEmpty()) {
                ...
                if (st.contains("HOÀN") || st.contains("HOAN") || st.contains("DONE") || st.contains("COMPLETED")) {
                    jpql.append(" AND (UPPER(l.processingStatus) = 'DONE' OR UPPER(l.processingStatus) LIKE '%HOÀN%' OR UPPER(l.processingStatus) LIKE '%HOAN%' OR UPPER(l.processingStatus) LIKE '%DONE%')");
                } else {
